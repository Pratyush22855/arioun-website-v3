...
const services = [
  {
    ...
    body: 'We map your most time-consuming processes and replace them with intelligent automations. From lead follow-up to invoice generation — if it\'s repetitive, we automate it.',
    features: ['Lead capture & nurture sequences', 'Automated follow-up & scheduling', 'Document processing & data entry', 'CRM updates & pipeline management'],
    color: '#7c3aed',
    colorLight: '#a78bfa',
    glow: 'rgba(124,58,237,0.22)',
    borderGlow: 'rgba(124,58,237,0.5)',
    gradient: 'linear-gradient(135deg, rgba(124,58,237,0.14) 0%, rgba(124,58,237,0.02) 100%)',
    span: 'lg:col-span-2',
  },
  {
    tag: null,
    ...
    body: 'Conversational agents trained on your business that handle support, qualify leads, book appointments, and answer questions — 24/7, no breaks.',
    features: ['Website chat & support agents', 'Lead qualification bots', 'Appointment booking agents', 'Internal knowledge assistants'],
    color: '#22d3ee',
    colorLight: '#67e8f9',
    glow: 'rgba(34,211,238,0.18)',
    borderGlow: 'rgba(34,211,238,0.4)',
    gradient: 'linear-gradient(135deg, rgba(34,211,238,0.12) 0%, rgba(34,211,238,0.02) 100%)',
    span: 'lg:col-span-2',
  },
  {
    tag: null,
    ...
    body: 'Connect your tools, CRMs, and platforms into a unified AI-powered workflow that passes data automatically — zero manual entry.',
    features: ['HubSpot / Go High Level', 'Google Workspace', 'Zapier & Make.com', 'Custom API bridges'],
    color: '#f59e0b',
    colorLight: '#fcd34d',
  ...
  },
  {
    ...
    body: 'Personalised email and SMS sequences generated by AI — triggered by behaviour, profile, and pipeline stage. More replies, more bookings, less effort.',
    features: ['Personalised email sequences', 'SMS follow-up automation', 'Behaviour-triggered sends', 'Re-engagement campaigns'],
    color: '#10b981',
    colorLight: '#6ee7b7',
  ...
  },
  {
    ...
    body: 'AI-generated business reports delivered to your inbox — weekly performance summaries, anomaly alerts, and actionable insights automatically.',
    features: ['Weekly AI reports', 'Anomaly detection', 'Pipeline analytics', 'Custom dashboards'],
    color: '#ec4899',
    colorLight: '#f9a8d4',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${hovered ? service.borderGlow : 'rgba(124,58,237,0.12)'}`,
  ...
  return (
    <section id="services" className="relative py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Bottom CTA */}
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }} className="relative rounded-3xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6 overflow-hidden gradient-border" style={{ background: 'rgba(7,4,26,0.8)' }}>
